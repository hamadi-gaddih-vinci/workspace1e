...
public class TestTableauTrieDEntiersPlus {
    ...
    public static void main(String [] args){
        ...
        do{
            ...
            System.out.println("3 -> Tester la methode 'supprimerEntre(int borneInf, int borneSup)'");
            System.out.println("4 -> Tester la methode 'supprimerTousLesExAequos()'");
            System.out.print("\nEntrez votre choix : ");
            ...
            switch(choix){
                ...
                case 2: supprimerTout();
                    break;
                case 3: supprimerEntre();
                    break;
                case 4: testerSupprimerTousLesExAequos();
                    break;
            }
