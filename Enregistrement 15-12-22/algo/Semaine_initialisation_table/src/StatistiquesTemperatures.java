...
public class StatistiquesTemperatures {
	...
	public static void main(String[] args) {
		...
		do{
			...
			System.out.println("3 -> afficher jours de gel");
			System.out.println();
	...
	private static void afficherMoyenne() {
		// TODO
		System.out.println("La moyennes des temperatures du mois de janvier est de : " + temperatures.moyenne());
	}
