...
public class FileDePrioriteDEntiersImpl implements FileDePrioriteDEntiers {
	...
	public void insere(int entier) {
		...
		arbre[taille]=entier;
		// on réorganise l'arbre pour qu'il soit complet
	...
	public int supprimeMax(){
		...
		/*if (arbre[0] < arbre[indiceDroit(0)]){
			int droit = arbre[indiceDroit(0)];
			arbre[indiceDroit(0)] = arbre[0];
			arbre[0] = droit;
		*/
