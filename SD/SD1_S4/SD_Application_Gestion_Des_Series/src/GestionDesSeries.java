...
public class GestionDesSeries {
	...
	private static void rechercherSerie() {
		...
		//TODO
		System.out.println("Dans la classe GestionDesSeries : " + classe.numeroSerie(nom));
	...
	private static void afficherTailleSeries() {
		...
		for (int i = 1; i <= classe.nombreSeries(); i++) {
			System.out.println("Le nombre d'étudiant de la série " + (i) + ": " + classe.getSerieEtudiants(i).nombreEtudiants());
		}
