public class TestEnsembleVoituresAutorisees{
	...
	public static void main(String[] args) {	
		...
		if(e.retirerVoiture(new Voiture("1BBB000",""))){
			System.out.println("La voiture a deja ete supprimer");
		}

		System.out.println("Cas 6 : nouvelle verification de la presence des voitures 1AAA000 et 1CCC000");
		//System.out.println("VOUS DEVEZ COMPLETER CE TEST!");
		if(!e.voitureAutorisee(new Voiture("1AAA000","")) ||!e.voitureAutorisee(new Voiture("1CCC000",""))){
		...
		if (e.ajouterVoiture(new Voiture("1AAA000",""))){
			System.out.println("Voiture deja presente");
			return;
		}
		System.out.println(" ");
		System.out.println("Tout les tests ont reussi");
	}
