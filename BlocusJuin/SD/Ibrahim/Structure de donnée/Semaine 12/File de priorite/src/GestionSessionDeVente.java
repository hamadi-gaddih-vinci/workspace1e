...
public class GestionSessionDeVente {
	...
	public static void main(String[] args) {
		...
		do {
			...
			System.out.println("4 -> Voir si le client à bien été retirer");
			System.out.println();
	...
	private static void clientSuivant () {
		String client = session.selectionnerClientSuivant();
		if (client != null){
			System.out.println("Le client à bien été séléctionner et il s'agit de : " + client);
		}
		else{
			System.out.println("Le client n'a pas pu être selectionner");
		}
	}
