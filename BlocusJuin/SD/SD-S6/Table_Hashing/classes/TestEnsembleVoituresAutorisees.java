public class TestEnsembleVoituresAutorisees{
	...
	public static void main(String[] args) {
		...
		if(e.retirerVoiture(p1BBB000)){
			System.out.println("la voiture n'est pas prÃ©sente mais la mÃ©thode revoie true");
			return;
		}
		...
		if(!e.voitureAutorisee(p1AAA000) || !e.voitureAutorisee(p1CCC000)){
			System.out.println("MÃ©thode indique que ces voitures ne sont pas autorisÃ©es");
			return;
		}
		...
		if(e.ajouterVoiture(new Voiture("1AAA000", ""))){
			System.out.println("Voiture ajoutÃ©e mais Ã©tait dÃ©jÃ  prÃ©sente");
			return;
		}

		System.out.println("TOUS LES TEST ONT REUSSIS!");
