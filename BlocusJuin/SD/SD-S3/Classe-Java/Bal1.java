public class Bal1 implements Bal{
    ...
    public void ajouterEtudiant(Etudiant etudiant) {
        ...
        NoeudEtudiant nvNoeud = new NoeudEtudiant(etudiant);
        if (nvNoeud.etudiant.getSexe() == 'M'){
            nvNoeud.suivant = derM.suivant;
            derM.suivant = nvNoeud;
            derM = nvNoeud;
        }
        else {
            derF.etudiant = etudiant;
            derF.suivant = new NoeudEtudiant(null);
            derF = derF.suivant;
        }
        }
        //TODO
