public class TestBoisson {
    public static void main(String[] args) {
        ...
        Boisson coktail = new BoissonAlcoolisees("Bloody Mary", 12, 9, 14);
        ...
        Boisson orval = new Bieres("Orval",33,4,6.2,false);
        System.out.println(orval);
        Boisson jupiler = new Bieres("Jupiler",33,2.5,5.2,true);
