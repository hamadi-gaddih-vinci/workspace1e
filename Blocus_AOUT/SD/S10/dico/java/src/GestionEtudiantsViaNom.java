...
public class GestionEtudiantsViaNom {
    ...
    public static Comparator<Etudiant> comparateur = new ComparateurViaNom();
    public static TreeSet<Etudiant> ensembleEtudiants = new TreeSet<Etudiant>(comparateur);
    ...
    private static void ajout(){
        System.out.println();
        System.out.print("Entrez le numéro de matricule : ");
