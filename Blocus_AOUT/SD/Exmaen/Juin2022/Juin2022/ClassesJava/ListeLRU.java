...
public class ListeLRU<E> {
	...
	public boolean supprimer (E element) {
		...
		noeudAsupp.precedent.suivant = noeudApres;
		noeudApres.precedent = noeudAsupp.precedent;
	...
	public E supprimerDernier() {
		...
		if (tete.suivant == queue)
			return null;
		Noeud noeudASupp = queue.precedent;
		E ele = noeudASupp.element;
		noeudASupp.precedent.suivant = queue;
		queue.precedent = noeudASupp.precedent;
		mapElementNoeud.remove(ele);
		return ele;
	}
