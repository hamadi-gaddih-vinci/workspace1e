...
public class ListeRecCaracteres {
	...
	private boolean contient(NoeudCaractere noeudCaractere, char caractereARecherche){
		if (noeudCaractere == null)
			return false;
		if (noeudCaractere.caractere == caractereARecherche)
			return true;
		return contient(noeudCaractere.suivant, caractereARecherche);
	}
	...
	private int nombreOccurrences(NoeudCaractere noeud, char caractereARecherche){
		if (noeud == null)
			return 0;
		int nb = 0;
		if (noeud.caractere == caractereARecherche)
			nb++;
		return nb + nombreOccurrences(noeud.suivant, caractereARecherche);
	}
	...
	private void enArrayList(NoeudCaractere noeudCaractere, ArrayList<Character> arrayList){
		if (noeudCaractere ==  null)
			return;
		arrayList.add(noeudCaractere.caractere);
		enArrayList(noeudCaractere.suivant, arrayList);
	}
	...
	private boolean estEgalA(NoeudCaractere noeudCaractere1, NoeudCaractere noeudCaractere2){
		if (noeudCaractere1 == null && noeudCaractere2 == null)
			return true;
		if (noeudCaractere1 == null || noeudCaractere2 == null)
			return false;
		if (noeudCaractere1.caractere != noeudCaractere2.caractere)
			return false;
		return estEgalA(noeudCaractere1.suivant, noeudCaractere2.suivant);
	}
