...
public class TestBar {
	...
	public static void main(String[] args) {
		...
		CarteBoisson carte = new CarteBoisson();
		...
		System.out.println("jus2 présent dans la carte : " + carte.estPresent(jus2));
		System.out.println("Nombre de boissons à la carte : " + carte.nombreBoisson());
		...
		System.out.println("Nombres de boissons à la carte : " + carte.nombreBoisson());
		System.out.println("Retrait de jus2 de la carte : " + carte.retirer(jus2));
		System.out.println("jus1 présent dans la carte : " + carte.estPresent(jus1));
		System.out.println("Nombre de boissons à la carte : " + carte.nombreBoisson());
		System.out.println("Ajout de jus2 à la carte : " + carte.ajouter(jus2));
